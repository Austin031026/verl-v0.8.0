...
BUNDLE_DIR="$FENG_J/opsd_training/Qwen3-1.7B/qwen3_1p7b_openthought_math_reason_4k"
...
CHECKPOINT_DIR="$FENG_J/checkpoints/qwen3_1p7b_openthought_math_reason_4k"

# ---------- 实验配置 ----------

EXPERIMENT_NAME=qwen3_1p7b_openthought_math_reason_4k
TRAIN_BATCH_SIZE=32
