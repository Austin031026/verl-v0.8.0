...
TRAINING_RUN_ID=qwen3_4b_openthought_math_official_solution_reason_4k_reverse_kl_b54_n1_full_vocab_g6
...
TRAIN_FILE="$FENG_J/data/Ashkchamp-Openthoughts_math_filtered_30K/train_10000_seed42_verl_opsd_official_solution_reason.parquet"
...
OPSD_REASON_SOURCE=official_solution
